...
export default function Formulario(props) {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            <Form.Group as={Row} controlId="unidad_medida">
                <Form.Label column sm="2">
                    Unidad de Medida
                </Form.Label>
                <Col sm="10">
                    <Form.Control type="text" name="unidad_medida" required value={formulario.unidad_medida} onChange={handleChange} placeholder="unidad_medida" />
                </Col>
            </Form.Group>
